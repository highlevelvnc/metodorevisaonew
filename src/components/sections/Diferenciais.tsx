...
const diferenciais = [
  {
    ...
    desc: 'Uma especialista real lê sua redação inteira, entende sua argumentação e devolve um feedback que faz sentido para o seu nível. Não é checklist automático.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Você recebe nota e comentário em cada uma das 5 competências do ENEM. Sabe exatamente onde está forte e onde precisa melhorar.',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    desc: 'Não apontamos só o erro — identificamos o padrão. Se você erra sempre na C3, você vai saber disso já na segunda correção. Isso muda o jogo.',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    desc: 'Não é uma correção solta. Cada devolutiva considera as anteriores. Sua especialista conhece seu histórico e guia sua evolução com contexto.',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    desc: 'Você não fica semanas esperando. Corrigiu, enviou — em até 48 horas tem seu feedback completo para já aplicar na próxima.',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    desc: 'Não vendemos aula gravada, apostila nem acesso a plataforma. Vendemos uma coisa só: sua nota subindo, redação a redação.',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <div className="section-container">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="section-title mb-3">
            ...
            <span className="gradient-text">Somos o acompanhamento que faltava na sua preparação.</span>
          </h2>
        </div>
          ...
          <div className="grid grid-cols-3 text-center divide-x divide-white/[0.06]">
            ...
            <div className="px-4 py-5 bg-purple-600/[0.06]">
              ...
              <ul className="space-y-2 text-xs text-gray-300">
                ...
                <li className="font-medium">Devolutiva em até 24h</li>
              </ul>
            </div>
            <div className="px-4 py-5">
              <p className="text-xs text-gray-600 font-semibold uppercase tracking-wide mb-3">
