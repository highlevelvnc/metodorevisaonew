const dores = [
  {
    ...
    desc: 'Escreve a redação, entrega... e nunca entende de verdade o que errou. Sem saber o que corrigir, você repete os mesmos erros na próxima.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Um corretor analisa dezenas de redações por dia. A sua é mais uma. O feedback é raso, genérico e não acompanha sua evolução individual.',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    desc: 'Ferramentas de IA apontam erros gramaticais, mas não entendem sua argumentação, sua tese ou a coerência do texto. Correção de redação exige leitura humana.',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    desc: 'Escrever sem saber o que priorizar é como treinar sem ficha na academia. Sem diagnóstico claro dos seus pontos fracos, o esforço não vira resultado.',
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
