      ...
      <div className="section-container">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm text-gray-300 leading-relaxed">
                  O padrão que observamos: alunos que enviam redações com frequência e aplicam o feedback da devolutiva anterior <strong className="text-white">evoluem mais rápido</strong>. Quando o diagnóstico por competência mostra exatamente onde estão os erros — C3, proposta de intervenção, coesão — o aluno sabe onde focar. <strong className="text-purple-400">Direção clara produz resultado mensurável</strong>.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-10 text-center">
          ...
          <Link
            ...
            onClick={() => { trackEvent('landing_cta_clicked', { source: 'transformacao', target: 'cadastro' }); trackEvent('cta_click', { source: 'transformacao' }) }}
          >
