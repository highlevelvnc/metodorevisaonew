...
// CSSProperties extended to allow CSS custom properties (--var-name)
type CardStyle = React.CSSProperties & { [key: string]: string | number | undefined }
...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  const getSizeClasses = (): string => (customSize ? '' : sizeMap[size])

  const getInlineStyles = (): CardStyle => {
    const s: CardStyle = {
      '--base':           base,
      '--spread':         spread,
      '--radius':         '14',
