...
/** Single element: fade up from slight offset */
const fadeUp = {
...
/** Shared whileInView viewport — fires once when element is 72px from edge */
const vp = { once: true, margin: '-72px' }

/** Card hover — premium, not bouncy */
const cardHover = { y: -3, transition: { duration: 0.22, ease: [0.4, 0, 0.2, 1] as const } }
...
export default function ParaEscolasContent() {
  return (
    // MotionConfig respects the user's OS-level "reduce motion" preference automatically
    <MotionConfig reducedMotion="user">
      <div className="bg-[#080d18] min-h-screen">

        {/* ══════════════════════════════════════════════════════════
            HERO — on-mount cascade, no scroll trigger needed
        ══════════════════════════════════════════════════════════ */}
        <section className="relative overflow-hidden pt-32 pb-24 md:pt-40 md:pb-32">
          ...
          {/* Layer 2: Cinematic overlay
              - Top 0%:  0.90 → heavy dark for navbar bleed
              - Mid 38%: 0.62 → slightly open, institutional texture visible (tighter than before for mobile)
              - Mid 65%: 0.72 → closing before CTA zone
              - Bot 100%: 0.95 → near-opaque, CTA + trust bar always readable
              Fallback: bg-[#080d18] if style prop fails
          */}
          <div
            className="absolute inset-0 bg-[#080d18]"
            style={{
              background: 'linear-gradient(to bottom, rgba(8,13,24,0.90) 0%, rgba(8,13,24,0.62) 38%, rgba(8,13,24,0.72) 65%, rgba(8,13,24,0.95) 100%)',
            }}
          />

          {/* Layer 3: Brand purple wash */}
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[320px] bg-purple-700/[0.14] rounded-full blur-3xl" />
          </div>

          {/* Layer 4: Content — cascaded fade-up on mount */}
          <div className="section-container relative z-10 text-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.50, ease, delay: 0.15 }}
              className="inline-flex items-center gap-2 bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-semibold px-4 py-1.5 rounded-full mb-8 tracking-widest uppercase"
            >
            ...
            <motion.h1
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.60, ease, delay: 0.26 }}
              className="text-[2.1rem] sm:text-5xl lg:text-[3.2rem] font-extrabold text-white leading-[1.1] tracking-tight mb-6 max-w-3xl mx-auto"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-gray-300 leading-relaxed max-w-xl mx-auto mb-10"
            >
            ...
            <motion.div
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.50, ease, delay: 0.50 }}
            >
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
                <motion.a
                  ...
                  className="btn-primary px-7 py-3.5 text-sm font-bold rounded-xl shadow-[0_0_24px_rgba(124,58,237,0.22)] hover:shadow-[0_0_32px_rgba(124,58,237,0.38)]"
                >
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.55, ease, delay: 0.64 }}
          ...
          <div className="section-container">
            ...
            >
              ...
              <p className="section-subtitle mx-auto max-w-2xl">
                A sala de aula não foi desenhada para oferecer feedback individual e estratégico em
                cada redação. Em turmas de 30 alunos, isso é impossível sem ajuda. O resultado é uma
                escola que pratica redação, mas não produz evolução mensurável.
              </p>
            </motion.div>
            ...
            >
              {painPoints.map((p) => (
                <motion.div
                  ...
                  className="card-dark p-7 cursor-default"
                >
                  <div className="w-10 h-10 rounded-xl bg-red-500/[0.08] border border-red-500/[0.15] flex items-center justify-center mb-5">
                    {p.icon}
                  </div>
              ...
              <div className="grid lg:grid-cols-2 gap-10 items-center">
                ...
                >
                  ...
                  <p className="text-gray-400 text-base leading-relaxed">
                    A escola passa a ter visibilidade real: quem evoluiu, quem precisa de atenção,
                    quais competências estão mais fracas na turma. Dados concretos para decisões
                    pedagógicas concretas.
                  </p>
                </motion.div>

                {/* Right — flow pills staggered */}
                <motion.div
                  initial="hidden" whileInView="visible" viewport={vp}
                  variants={stagger}
                  className="space-y-3"
                >
                  {flowPills.map((item, i) => (
                    <motion.div
                      key={i}
                      variants={cardReveal}
        ...
        <section className="section-padding">
          <div className="section-container">
            ...
            {/* Two benefit cards — stagger entrance, no hover lift (cards are large) */}
            <motion.div
              initial="hidden" whileInView="visible" viewport={vp}
              variants={stagger}
            ...
            >
              ...
              {/* Students */}
              <motion.div variants={cardReveal} className="card-dark p-7 border-purple-500/[0.14]">
              ...
              {/* School */}
              <motion.div variants={cardReveal} className="card-dark p-7 border-green-500/[0.14]">
                <div className="flex items-center gap-3 mb-6">
        ...
        <section id="como-funciona" className="section-padding" style={{ background: 'rgba(255,255,255,0.015)' }}>
          <div className="section-container">
            ...
            {/* Step cards — staggered + hover lift */}
        ...
        <section className="section-padding">
          <div className="section-container">
            ...
            {/* Tier cards — stagger, no hover lift (popular has CSS scale treatment) */}
            <motion.div
              initial="hidden" whileInView="visible" viewport={vp}
              variants={stagger}
              className="grid md:grid-cols-3 gap-5 max-w-4xl mx-auto"
        ...
        <section className="section-padding relative overflow-hidden" style={{ background: 'rgba(255,255,255,0.015)' }}>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-purple-700/[0.08] rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="section-container relative">
            ...
            >
              ...
              {/* Mini-cards — stagger within the already-animated parent */}
              <motion.div
                initial="hidden" whileInView="visible" viewport={vp}
                variants={stagger}
              ...
              >
                {pilotCards.map((item) => (
                  <motion.div
                    key={item.title}
                    variants={cardReveal}
                    whileHover={{ y: -2, transition: { duration: 0.20, ease: [0.4, 0, 0.2, 1] as const } }}
                    className="card-dark p-5 text-center cursor-default"
                  >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.972 }}
                transition={{ duration: 0.16, ease }}
                className="btn-primary px-8 py-4 text-base font-bold rounded-xl inline-flex items-center gap-2 shadow-[0_0_24px_rgba(124,58,237,0.20)] hover:shadow-[0_0_32px_rgba(124,58,237,0.36)]"
              >
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.972 }}
                  transition={{ duration: 0.16, ease }}
                  className="btn-primary px-7 py-3.5 text-sm font-bold rounded-xl inline-flex items-center gap-2 shadow-[0_0_24px_rgba(124,58,237,0.20)] hover:shadow-[0_0_32px_rgba(124,58,237,0.36)]"
                >
                  <WaIcon />
                  Solicitar proposta para minha escola
                </motion.a>
