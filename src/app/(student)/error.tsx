...
/**
 * Error boundary for the student area (/aluno/*).
 * Renders inside the student layout — sidebar and nav remain visible.
 */
...
export default function StudentError({
  ...
  useEffect(() => {
    console.error('[StudentError]', error.message, error.digest)
  }, [error])
