  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-white mb-1.5">Biblioteca de Temas</h1>
        <p className="text-sm text-gray-500">
          Temas reais do ENEM e vestibulares para você praticar com contexto e profundidade.
        </p>
      </div>
      ...
      {allThemes.length === 0 ? (
        <div className="card-dark rounded-2xl p-10 text-center">
          <div className="w-10 h-10 rounded-2xl bg-white/[0.04] border border-white/[0.06] flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-sm font-medium text-gray-400 mb-1">Nenhum tema encontrado</p>
